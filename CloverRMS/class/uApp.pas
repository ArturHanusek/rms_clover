...
type
  ...
  private
    procedure makeSale(amount: double; var saleResult: Integer);
    procedure makeRefund(amount: double; var saleResult: Integer);
...
begin
  ...
  Begin
    ...
    makeSale(tender.AmountIn, saleResult);
    Result := saleResult = 1;
  ...
  Begin
    Debug.Send('Making refund:', tender.AmountIn);
    makeRefund(tender.AmountOut, saleResult);
    Result := saleResult = 1;
    exit;
  End;
...
procedure TApp.makeRefund(amount: double; var saleResult: Integer);
begin
  makeSale(-1 * amount, saleResult);
end;

procedure TApp.makeSale(amount: double; var saleResult: Integer);
var
